...
#         score = pipe.score(X_test, y_test)  # accuracy
...
#     ax.bar(df_results['model'], df_results['accuracy'], color=['#1f77b4','#ff7f0e','#2ca02c'])
#     ax.set_ylim(0,1)
...
#     fig.savefig(f'{FIG_DIR}/model_comparison.png', dpi=300)
#     plt.close(fig)
